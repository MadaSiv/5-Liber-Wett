...
# Zeitzone Schweiz (robust mit Fallback)
try:
...
class Pot:
    ...
    # ---- State (De)Serialisierung & Recalc ----
...
# WICHTIG: für Hoster wie Render PORT aus Env übernehmen
import os
ui.run(
